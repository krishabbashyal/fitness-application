...
const NavBar = () => {
  return (
    <div className="bg-white w-full h-[78px] rounded-t-lg drop-shadow-lg fixed bottom-0 z-50 flex justify-around">
      <button>
        <div className="text-center">
          <img className="ml-[19px] w-7" src={DashboardIcon} alt="" />
          <p className="pb-1 pt-0.5 text-sm">Dashboard</p>
        </div>
      </button>
      <button>
        <div>
          <img className="ml-[11px] w-7" src={ExploreIcon} alt="" />
          <p className="pb-1 pt-0.5 text-sm">Explore</p>
        </div>
      </button>
      <button>
        <div>
          <img className="ml-[14px] w-7" src={ProgressIcon} alt="" />
          <p className="pb-1 pt-0.5 text-sm">Progress</p>
        </div>
      </button>
      <button>
        <div>
          <img className="ml-[6px] w-7" src={ProfileIcon} alt="" />
          <p className="pb-1 pt-0.5 text-sm">Profile</p>
        </div>
      </button>
    </div>
  );
