...
const CurrentSet = ({
  ...
  return (
    <div className='my-3'>
      <div className="bg-gray-800 pb-5 pt-1 text-white rounded-lg max-w-sm mx-4 text-center">
      
        {/* Display exercises as a list */}
        <ul className="my-4">
          {exercise && <li>{exercise}</li>}
        </ul>
        <div className="flex flex-row space-x-4 justify-center items-center">
          <section>
            <input
              type="number"
              className="text-center w-16 rounded text p-1 mr-2"
              placeholder="X"
            />
            <span className="rounded font-medium">Reps</span>
          </section>
          <section>
            <input
              type="number"
              ...
              placeholder="X"
            />
            <span className="rounded py-1 font-medium">Lbs</span>
          </section>
        </div>
